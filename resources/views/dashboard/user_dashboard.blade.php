        ...
        <div class="rounded-2xl bg-gradient-to-r from-blue-900 to-indigo-900 p-6 sm:p-8 shadow-2xl overflow-hidden relative">
            ...
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-center">
                <div class="text-white mb-6 md:mb-0">
                    <h1 class="text-3xl sm:text-4xl font-bold mb-2">Bonjour, {{ Auth::user()->name ?? 'Membre' }}! 👋</h1>
                ...
                <div class="relative">
                    <div class="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-gradient-to-br from-white to-blue-100 flex items-center justify-center text-4xl font-bold text-blue-900 border-4 border-yellow-400 shadow-xl">
    ...
    <div class="max-w-7xl mx-auto mb-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="stat-card glass-effect rounded-xl p-6 shadow-lg hover:shadow-xl border-l-4 border-blue-500">
                ...
                <div class="mt-4 pt-4 border-t border-gray-100">
                    <a href="{{ route('adhesion') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center">
            ...
            <div class="stat-card glass-effect rounded-xl p-6 shadow-lg hover:shadow-xl border-l-4 border-purple-500">
                ...
                <div class="mt-4 pt-4 border-t border-gray-100">
                    <a href="{{ route('partenaire') }}" class="text-purple-600 hover:text-purple-800 text-sm font-medium flex items-center">
                ...
                <div class="glass-effect rounded-2xl p-6 shadow-lg mb-8">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <a href="{{ route('partenaire') }}" class="group bg-gradient-to-br from-white to-purple-50 rounded-xl p-5 shadow-md hover:shadow-xl transition-all duration-300 border border-purple-100 hover:border-purple-300 text-center">
                            ...
                            <span class="font-medium text-gray-700 group-hover:text-purple-700">Devenir partenaire</span>
                        </a>

                        <a href="" class="group bg-gradient-to-br from-white to-gray-50 rounded-xl p-5 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-gray-300 text-center">
                ...
                <div class="glass-effect rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="border-b border-gray-200">
                        <nav class="flex flex-wrap -mb-px">
                            <button data-tab="dons" class="tab-btn inline-flex items-center py-4 px-6 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 transition-colors">
                                <i class="fas fa-heart mr-2"></i>
                                Mes Dons
                            </button>
                            <button data-tab="adhesions" class="tab-btn inline-flex items-center py-4 px-6 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 transition-colors">
                                <i class="fas fa-user-check mr-2"></i>
                                Mes Adhésions
                            </button>
                            <button data-tab="benevolat" class="tab-btn inline-flex items-center py-4 px-6 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 transition-colors">
                                <i class="fas fa-hands-helping mr-2"></i>
                                Mon Bénévolat
                            </button>
                            <button data-tab="partenariats" class="tab-btn inline-flex items-center py-4 px-6 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 transition-colors">
                                <i class="fas fa-handshake mr-2"></i>
                                Mes Partenariats
                            </button>
                            <button data-tab="documents" class="tab-btn inline-flex items-center py-4 px-6 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 transition-colors">
                    ...
                    <div class="p-6">
                        ...
                        <div id="dons" class="tab-pane">
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <button onclick="exportDonations()" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors">
                            ...
                            <div id="membershipsContent" style="display: none;">
                                <div class="max-w-2xl mx-auto">
                                    <div class="gradient-border rounded-2xl p-8 text-center">
                                        <div class="bg-blue-100 text-blue-600 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                                            <i class="fas fa-user-check text-3xl"></i>
                                        </div>
                                        <h3 id="membershipStatus" class="text-2xl font-bold text-gray-800 mb-3">Non adhérent</h3>
                                        <p id="membershipDetails" class="text-gray-600 mb-6">Vous n'avez pas encore adhéré à la fondation</p>
                                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                            <a href="{{ route('adhesion') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg font-medium transition-all shadow-md hover:shadow-lg">
                                                <i class="fas fa-user-plus mr-2"></i>
                                                Adhérer maintenant
                                            </a>
                                            <a href="#" class="inline-flex items-center px-6 py-3 bg-white border border-blue-600 text-blue-600 hover:bg-blue-50 rounded-lg font-medium transition-colors">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                    <div class="bg-gradient-to-br from-yellow-50 to-white rounded-xl p-6 border border-yellow-100">
                                        <div class="text-center">
                                            <div class="text-3xl font-bold text-yellow-600 mb-2" id="totalHours">0</div>
                                            <div class="text-sm font-medium text-gray-700">Heures totales</div>
                                        </div>
                                    </div>
                                    <div class="bg-gradient-to-br from-yellow-50 to-white rounded-xl p-6 border border-yellow-100">
                                        <div class="text-center">
                                            <div class="text-3xl font-bold text-yellow-600 mb-2" id="completedMissions">0</div>
                                            <div class="text-sm font-medium text-gray-700">Missions terminées</div>
                                        </div>
                                    </div>
                                    <div class="bg-gradient-to-br from-yellow-50 to-white rounded-xl p-6 border border-yellow-100">
                                        <div class="text-center">
                                            <div class="text-xl font-bold text-yellow-600 mb-2" id="mainDomain">Aucun</div>
                        ...
                        <div id="documents" class="tab-pane hidden">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                                <div class="bg-gradient-to-br from-white to-blue-50 rounded-xl p-6 border border-blue-100 hover:border-blue-300 transition-colors cursor-pointer" onclick="generateReceipt()">
                                    <div class="bg-blue-100 text-blue-600 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <i class="fas fa-file-invoice text-2xl"></i>
                                    </div>
                                    <h4 class="font-bold text-gray-800 text-center mb-2">Reçu fiscal</h4>
                                    <p class="text-gray-600 text-sm text-center">Générez votre reçu fiscal pour déduction</p>
                                </div>

                                <div class="bg-gradient-to-br from-white to-yellow-50 rounded-xl p-6 border border-yellow-100 hover:border-yellow-300 transition-colors cursor-pointer" onclick="downloadCertificate()">
                                    <div class="bg-yellow-100 text-yellow-600 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <i class="fas fa-award text-2xl"></i>
                                    </div>
                                    <h4 class="font-bold text-gray-800 text-center mb-2">Certificat de bénévolat</h4>
                                    <p class="text-gray-600 text-sm text-center">Téléchargez votre certificat de bénévolat</p>
                                </div>

                                <a href="" class="bg-gradient-to-br from-white to-gray-50 rounded-xl p-6 border border-gray-100 hover:border-gray-300 transition-colors">
                                    <div class="bg-gray-100 text-gray-600 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <i class="fas fa-folder-open text-2xl"></i>
                                    </div>
                                    <h4 class="font-bold text-gray-800 text-center mb-2">Tous mes documents</h4>
                                    <p class="text-gray-600 text-sm text-center">Accédez à l'ensemble de vos documents</p>
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-200">
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex space-x-6">
                ...
                <a href="#" class="text-gray-500 hover:text-blue-600 text-sm transition-colors">Confidentialité</a>
